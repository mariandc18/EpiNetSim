...
def spreading_make_seirs_model(pInfect, pExposedToInfectious, pRecover, pLossImmunity):  
    def model(g, i):  
...
model = spreading_make_seirs_model(0.3, 0.2, 0.1, 0.05)
